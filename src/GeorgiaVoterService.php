...
/**
 * Description of GeorgiaVoterService
 *
 * @author james
 */
class GeorgiaVoterService extends \GCG\Core\Connection {
    ...
    public function buildUpdateSQL($voterIds) {
    ...
    public function generateUpdate($voter) {
